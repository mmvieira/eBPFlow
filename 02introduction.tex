...
To address this, it is important for the network to be efficient and programmable. But, providing an expressive (Turing-Complete) abstraction for network function packet processing in hardware remains a research challenge.
