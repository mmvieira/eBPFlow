...
\caption{switch datapath implemented in NetFPGA SUME.}
\label{fig:06_fig01}
\end{figure*}
\end{comment}
...
\begin{table}[htp]
\centering
\caption{Messages exchange between controller and switch.}
\label{tab:06_mes}
\begin{tabular}{|c|c|}
\hline
...
Install                  &  Install  eBPF\\
                         &  instruction on the switch                                                                                       \\ \hline
...
\begin{tabular}[c]{@{}c@{}}Table \\ command\end{tabular}  & \begin{tabular}[c]{@{}c@{}}Controller send command\\ (update, delete, lookup, list) to switch\end{tabular}               
\\ \hline
Packet In/Out                  &  Sends a packet to/from\\
                               &  switch from/to controller                                                                                       
\\ \hline

\end{tabular}
\end{table}

The controller and switch communicate via socket. After establishing the communication, both controller and switch can exchange messages with specific information. Table~\ref{tab:06_mes} displays the supported messages between controller and switch.
